    ...
    <div class="content flex col ai-fs">
      ...
      <div class="flex row mob:col-reverse ai-fs mt-10">
        <div class="flex row flex-wrap w-4/5 mob:w-full">
          <template v-for="(item, i) in list">
            <div class="flex col ai-fs mb-11 pr-6 w-1/3 mob:w-1/2" :key="i">
              <div
                class="item-image cursor-pointer w-full relative overflow-hidden"
                ref="product"
              >
                <div><img class="w-full h-full" :src="item.img" /></div>
                <div
                  class="sale color-white w-auto absolute py-2 px-6 bg-margon text-25"
                  v-if="item.sale"
                >
                  -{{ item.sale }}%
                </div>
                <svg
                  class="z-1 absolute fill-margon stroke-margon hover:fill-transparent"
                  width="37"
                  height="33"
                  viewBox="0 0 33 33"
                ...
                >
                  <path
                    d="M24.2344 1.93359C22.4437 1.93359 20.8019 2.50104 19.3548 3.6202C17.9675 4.69315 17.0438 6.05975 16.5 7.05349C15.9562 6.05969 15.0325 4.69315 13.6452 3.6202C12.1981 2.50104 10.5563 1.93359 8.76562 1.93359C3.76845 1.93359 0 6.02102 0 11.4413C0 17.2972 4.7014 21.3036 11.8187 27.3689C13.0273 28.3989 14.3973 29.5664 15.8212 30.8116C16.0089 30.9759 16.2499 31.0664 16.5 31.0664C16.7501 31.0664 16.9911 30.9759 17.1788 30.8116C18.6028 29.5663 19.9727 28.3988 21.1821 27.3682C28.2986 21.3036 33 17.2972 33 11.4413C33 6.02102 29.2316 1.93359 24.2344 1.93359Z"
                  />
                </svg>
              </div>
              <div class="flex row mob:col jc-sb mob:ai-fs w-full">
                ...
                <router-link
                  class="flex col mob:jc-fs b-o mob:b-1 radius-5 mob:px-7 mob:py-3 mob:w-auto b-solid mob:mt-3 mob:row cursor-pointer fill-black color-grey mob:color-black hover:fill-margon hover:color-margon"
                  to="zakaz"
                >
                  <svg
                    width="25"
                  ...
                  <span class="mt-1 text-12 mob:ml-2">В корзину</span>
                </router-link>
              </div>
            </div>
          </template>
        ...
        <div class="flex row w-1/5 mob:w-full mob:jc-sb">
          ...
          />
          <v-select
            class="mob:flex none b-1 b-solid border-l_grey radius-5 w-full ml-1 py-2 arrow-none"
            :options="[
              'По умолчанию',
              'По возрастанию',
              'По убыванию',
